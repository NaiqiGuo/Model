...
from model_utils import create_model, get_inputs, analyze, get_outputs, stabilize_with_lmi, stabilize_by_radius_clipping
...
print(f"Total events loaded and saved: {len(events)}")
...
for i, event in enumerate(events):
    ...
    with open(f"system_srim_{i+1:02d}.pkl", "wb") as f:
    ...
    with open(f"system_n4sid_{i+1:02d}.pkl", "wb") as f:
    ...
    with open(f"system_det_{i+1:02d}.pkl", "wb") as f:
