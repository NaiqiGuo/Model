...
def create_frame(elastic:bool,
    ...
    if not elastic:
        #                                    tag     Fy, E,  b,    R0,   cR1,   cR2  [, a1, a2, a3, a4])
    ...
    if coupons:
        if zerolength == 'element':
            ...
            coupon_shear_mat = 52
            coupon_shear_stiffness = 0.1 # kips/in stiffness for a uniaxial material that can be used with zerolength element
            coupon_axial_mat = 53
            coupon_axial_stiffness = fy*(4*units.inch)*(2*units.inch)/(8*units.inch) # kips/in stiffness for a uniaxial material that can be used with zerolength element
